...
![Digital Servo](../media/image/digital_servo_rds3230.png)

- `RDS3230 30kg` dual-axis digital servo, used as the three primary actuators of the 3RRS platform.

#### Driver | 驱动模块

![PCA9685 PWM Driver Board](../media/image/pca9685_pwm_driver_board.png)
...
![IMX219 Camera Module](../media/image/imx219_pi5_camera.png)
...
![Rod End Ball Joint](../media/image/rod_end_ball_joint_sa6tk.png)
...
![DC Adapter Plug](../media/image/dc_power_adapter_plug_5_5x2_5mm.png)
