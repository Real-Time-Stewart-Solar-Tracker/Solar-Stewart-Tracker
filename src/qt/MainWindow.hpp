...
#include "app/AppConfig.hpp"          // AppConfig, SensorMode
#include "common/Logger.hpp"          // Logger
...
public:
    explicit MainWindow(solar::Logger& log,
                        solar::app::AppConfig& cfg,
...
private:
    ...
    // =============================
    solar::Logger&        log_;
    solar::app::AppConfig& cfg_;
    std::unique_ptr<SystemManager> sys_;

    solar::app::SensorMode currentMode_{solar::app::SensorMode::CAMERA};

    void setupObservers_();
    void rebuildSystem_(solar::app::SensorMode mode);
    ...
    void setCameraControlsEnabled_(bool en);
